	 ...
	 <section>
		<div id="agileits-sign-in-page" class="sign-in-wrapper">
			...
			<h3>Book Appointment</h3>
				<form action="getbookappointment1.jsp" method="POST">
					<input type="text" class="form-control" id="fname" name="t1" placeholder="User Name here">
					<input type="text" class="form-control" id="cono1" name="t2" placeholder="Contact No Here">
					<input type="text" class="form-control" id="cono1" name="t3" placeholder="Email Id Here">
					<%@page import="java.sql.*" %>
<%@page import="javax.sql.*" %>

<select style="border-color:black" class="form-control" id="lname" name="t4">
    ...
    <%
        ...
        <option value="<% out.println(rs.getString(1)); %>"><% out.print(rs.getString(5)); %></option>
        <% }%>
...
<br>
    ...
    <%
        ...
        java.sql.ResultSet rs1=stmt.executeQuery("select * from subcategories");
        while(rs1.next())
            {
        %>
...
<br>
<select style="border-color:black" class="form-control" id="lname" name="t6">
    <option>Select Area name</option>
    <%

        java.sql.ResultSet rs2=stmt.executeQuery("select * from area");
        while(rs2.next())
            {
        %>
...
<br>
<input type="text" class="form-control" id="lname" name="t7" placeholder="timeslot Here">
<input type="text" class="form-control" id="email1" name="t8" placeholder="days Here">
