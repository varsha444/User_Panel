...
<html lang="en">
  ...
  rs4=stmt4.executeQuery("select * from subcategories");
        ...
        ResultSet rs1=stmt1.executeQuery("SELECT * FROM doctor1 inner JOIN subcategories on doctor1.sname='"+id+"'");
        rs1.next();
        ...
        ResultSet rs=stmt.executeQuery("SELECT * FROM doctor1 where doctor1.sname='"+id+"'");
        while(rs.next())
        {
        ...
        %> 
                                    ...
                                    <ul class="list">
                                            <li>
                                                <img src="images/<% out.println(rs.getString(23)); %>" title="" alt="" />
                                                <section class="list-left">
                                                    <h5 class="title"><% out.println(rs.getString(6)); %></h5>
                                                    <span class="adprice"><% out.println(rs.getString(22)); %></span>
                                                ...
                                                <section class="list-right">
                                                    <select name="t30">
                                                        <option><% out.println(rs.getString(12)); %></option>
                                                        <option><% out.println(rs.getString(13)); %></option>
                                                        <option><% out.println(rs.getString(14)); %></option>
                                                        <option><% out.println(rs.getString(15)); %></option>
                                                        <option><% out.println(rs.getString(16)); %></option>
                                                        <option><% out.println(rs.getString(17)); %></option>
                                                        <option><% out.println(rs.getString(18)); %></option>
                                                    </select>
