	...
	<!-- Large modal -->
		...
		<div class="container">
			<div class="agile-its-header">
				<div class="logo">
					<h1><a href="index.html"><span>DOC</span>TO-APP</a></h1>
				</div>
					...
					<div class="focus-grid w3layouts-boder8">
							<div class="focus-border">
									...
									<div class="focus-image"><i class="fa fa-asterisk"></i></div>
                                                                        <a href="">					<h4 class="clrchg">city entry</h4>
                                                                        </a>	
                                                            </div>
                                                            </a>
							</div>
						...
						<a class="btn-8" href="categories.html#parentVerticalTab10">
							<div class="focus-border">
								<div class="focus-layout">
									...
									<h4 class="clrchg">category entry</h4>
								</div>
							</div>
						</a>
					</div>
						...
						<a class="btn-8" href="categories.html#parentVerticalTab11">
							<div class="focus-border">
								<div class="focus-layout">
									...
									<h4 class="clrchg">subcategory entry</h4>
								</div>
							</div>
						</a>
					</div>
