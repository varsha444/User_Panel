...
<html lang="en">
  ...
  rs4=stmt4.executeQuery("select * from subcategories");
        ...
        String area=request.getParameter("browsers");
        String sub=request.getParameter("browser");
        
        ResultSet rs1=stmt1.executeQuery("SELECT * FROM doctor WHERE areaname='"+area+"' and subcategoryname='"+sub+"'");
        rs1.next();
                    ...
                    <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
                        <li role="presentation" class="active">
                            ...
                            <a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">
                                ...
                                <span class="text"><% out.println(sub); %></span>
                            </a>
                        </li>
        ...
        ResultSet rs=stmt.executeQuery("SELECT * FROM doctor WHERE areaname='"+area+"' and subcategoryname='"+sub+"'");
        while(rs.next())
        {
        ...
        %> 
                                    ...
                                    <ul class="list">
                                            <li>
                                                <img src="images/<% out.println(rs.getString(4)); %>" title="" alt="" />
                                                <section class="list-left">
                                                    <h5 class="title"><% out.println(rs.getString(6)); %></h5>
                                                    <span class="adprice"><% out.println(rs.getString(5)); %></span>
                                                ...
                                                <section class="list-right">
                                                    <select>
                                                        <option name="t30"><% out.println(rs.getString(12)); %></option>
                                                        <option name="t31"><% out.println(rs.getString(13)); %></option>
                                                        <option name="t32"><% out.println(rs.getString(14)); %></option>
                                                        <option name="t33"><% out.println(rs.getString(15)); %></option>
                                                        <option name="t34"><% out.println(rs.getString(16)); %></option>
                                                        <option name="t35"><% out.println(rs.getString(17)); %></option>
                                                        <option name="t36"><% out.println(rs.getString(18)); %></option>
                                                    </select>
                                               ...
                                               <input type="hidden" value="<% out.println(sub);%>" name="hf"/>     
