			...
			<div class="wthreenavigation">
				...
				<nav class="menu">
					<div class="icon-list">
						...
						<a href="categories.jsp#parentVerticalTab3"><i class="fa fa-fw fa-stethoscope"></i><span>Therapist and Nutritionists</span></a>
						<a href="categories.jsp#parentVerticalTab4"><i class="fa fa-fw fa-suitcase"></i><span>Alternative Medicine Practitioners</span></a>
...
Class.forName("com.mysql.jdbc.Driver");
    ...
    String id=request.getParameter("id").toString();
        ResultSet rs1=stmt1.executeQuery("select doctor.docid,doctor.subcategoryname,doctor.specialist,doctor.clinichospital,doctor.doctorname,doctor.areaname,doctor.qualification,doctor.experience,doctortime.opentime,doctortime.closetime,doctortime.days,doctor.contactno,doctor.emailid,doctor.website,doctor.consultingfees from doctor inner join doctortime on doctor.docid='"+id+"'");
rs1.next();
		...
		<div class="container">
			<div class="product-desc">
				...
				<div class="col-md-7 product-view">
					<h2><% out.println(rs1.getString(4)); %></h2>
					...
					<div class="product-details">
						<h4><span class="w3layouts-agileinfo">Doctor's Name </span> : <% out.println(rs1.getString(5)); %><div class="clearfix"></div></h4>
						<h4><span class="w3layouts-agileinfo">Qualification </span> : <% out.println(rs1.getString(7)); %></h4>
						<h4><span class="w3layouts-agileinfo">Area </span> : <% out.println(rs1.getString(6)); %></h4>
				...
				<div class="col-md-5 product-details-grid">	
						...
						<div style="background-color: white;margin: 20px;margin-left: 15%;margin-right: 0;"  >
                                                    <div>
                                                        ...
                                                        <div>
                                                            <input type="text" class="form-control" name="t2" placeholder="Patient/Visitor's Here">
                                                        </div>
                                                    </div>
                                                    <div>
                                                        <label><h5>Contact No.</h5></label>
                                                        <div>
                                                            <input type="text" class="form-control" name="t2" placeholder="Contact No. Here">
                                                        </div>
                                                    </div>
                                                    <div>
                                                        <label><h5>Email Id</h5></label>
                                                        <div>
                                                            <input type="email" class="form-control" name="t2" placeholder="Email Id Here">
                                                        </div>
                                                    </div>
                                                    <div>
                                                        <label><h5>Age</h5></label>
                                                        <div>
                                                            <input type="text" class="form-control" name="t2" placeholder="Age Here">
                                                        </div>
                                                    </div>
                                    ...
                                    <center> <button type="submit" class="btn btn-default" aria-label="Left Align">Submit</button></center>
                                    </div>
                                    </form>
				</div>
			<div class="clearfix"></div>
