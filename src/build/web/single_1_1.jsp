...
<%@page import="javax.sql.*" %>
    ...
    //String day=request.getParameter("t30");
   String d="SELECT * FROM doctor1 inner join time_slots on doctor1.docid=time_slots.docid where doctor1.docid='"+id+"'";
	...
	<div class="single-page main-grid-border">
		<div class="container">
			<div >
				...
				<div >
                                    <center><h2>Time Slots</h2></center>
                                    <center><h2>Doctor Id : <%//out.println(day);%><%out.println(id);%></h2></center>
					<div class="sub-categories">
					<%
Class.forName("com.mysql.jdbc.Driver");
        Connection con2=DriverManager.getConnection("jdbc:mysql://localhost:3306/doctoappnew","root","");
        Statement stmt2=con2.createStatement();
       ResultSet rs2=stmt2.executeQuery(d);
       
while(rs2.next())
{

                %>	
                <center><h4 ><a  href="single_1.jsp?id=<% out.println(rs2.getString(26)); %>" style="padding: 30px;line-height: 50px;display: inline;" ><% out.println(rs2.getString(26)); %></a> </h4></center>
			<%}%>			
					</div>
				</div>
