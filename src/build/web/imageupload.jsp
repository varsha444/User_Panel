                            ...
                            <form action="getimage.jsp"  method="POST">
                                <div >
                                     ...
                                     <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Doctor's Photo</label>
                                        <div class="col-sm-9">
                                            <input type="file" class="form-control" required="" onchange="validate()" id="nam" name="fileupload" >
                                        </div>
                                    </div>
