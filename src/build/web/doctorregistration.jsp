	 ...
	 <section>
		<div id="agileits-sign-in-page" class="sign-in-wrapper">
			...
			<h3>Doctor Registration</h3>
				<form action="getdoctorregistration.jsp" method="POST">
				 

<select style="border-color:black" class="form-control" id="fname" name="t1">
    <option>Select Sub Category name</option>
    <%
        Class.forName("com.mysql.jdbc.Driver");
        java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/doctoappnew","root","");
        java.sql.Statement stmt=con.createStatement();
        java.sql.ResultSet rs=stmt.executeQuery("select * from subcategories");
        while(rs.next())
            {
        %>
...
<br>
                                    <input type="text" class="form-control" id="fname" name="t2" placeholder="Specialist here">
					<input type="text" class="form-control" id="fname" name="t3" placeholder="Clinic/Hospital Name here">
					<input type="text" class="form-control" id="lname" name="t4" placeholder="Doctor Name Here">
					<%@page import="java.sql.*" %>
<%@page import="javax.sql.*" %>

<select style="border-color:black" class="form-control" id="lname" name="t5">
    <option>Select Area name</option>
    <%

        java.sql.ResultSet rs1=stmt.executeQuery("select * from area");
        while(rs1.next())
            {
        %>
...
<br>
					<input type="text" class="form-control" id="fname" name="t6" placeholder="Qualification here">
                                        <input type="text" class="form-control" id="fname" name="t7" placeholder="Experience here">
                                        <input type="text" class="form-control" id="lname" name="t8" placeholder="Open Time Here">
                                        <input type="text" class="form-control" id="email1" name="t9" placeholder="Close Time Here">
                                        <input type="text" class="form-control" id="fname" name="t10" placeholder="Open Days here">
                                        <input type="text" class="form-control" id="cono1" name="t11" placeholder="Contact No Here">
                                        <input type="text" class="form-control" id="cono1" name="t12" placeholder="Email Id Here">
                                        <input type="text" class="form-control" id="cono1" name="t13" placeholder="Website Here">
                                        <input type="text" class="form-control" id="cono1" name="t14" placeholder="Consulting Fees Here">
